...
### Story 1 — [As a player, I want to level up, so that I can be stronger]

- [ ] [Progression Tracking (Exp, Level)))]  [owner:: Peachy]  [estimate:: 10]  [status:: In Progress]
- [ ] [Design Level Up UI&Sprite]  [owner:: Fishe&Tap]  [estimate:: 4]  [status:: In Progress]
- [ ] [ออกแบบ Stats ของตัวละคร]  [owner:: Jo]  [estimate:: 2]  [status:: In Progress]
