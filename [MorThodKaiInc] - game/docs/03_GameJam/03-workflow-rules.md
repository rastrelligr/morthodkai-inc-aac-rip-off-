...
3. ถ้าเจ้าของไฟล์ไม่อยู่ ผู้ตัดสินใจสำรองคือ: [Peachy]
4. ห้ามแก้ conflict แบบเดาเอง — ถ้าไม่แน่ใจให้รอผู้ตัดสินใจ แม้จะเสียเวลารอ [10 นาที] ก็ตาม
